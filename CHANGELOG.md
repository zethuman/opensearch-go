...
- Bumps `github.com/aws/aws-sdk-go` from 1.44.45 to 1.44.249
...
- Adds code quality analysis tool ([#313](https://github.com/opensearch-project/opensearch-go/pull/313))
